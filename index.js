      ...
      ...Object.assign(
        ...
        ..._.map(gradients, (colors, name) => {
          ...
          return {
            ...
            [`.${e(`bg-gradient-t-${name}`)}`]: { backgroundImage: `linear-gradient(to top, ${colors.join(', ')})` },
            [`.${e(`bg-gradient-tr-${name}`)}`]: { backgroundImage: `linear-gradient(to top right, ${colors.join(', ')})` },
            [`.${e(`bg-gradient-tl-${name}`)}`]: { backgroundImage: `linear-gradient(to top left, ${colors.join(', ')})` },
            [`.${e(`bg-gradient-r-${name}`)}`]: { backgroundImage: `linear-gradient(to right, ${colors.join(', ')})` },
            [`.${e(`bg-gradient-b-${name}`)}`]: { backgroundImage: `linear-gradient(to bottom, ${colors.join(', ')})` },
            [`.${e(`bg-gradient-br-${name}`)}`]: { backgroundImage: `linear-gradient(to bottom right, ${colors.join(', ')})` },
            [`.${e(`bg-gradient-bl-${name}`)}`]: { backgroundImage: `linear-gradient(to bottom left, ${colors.join(', ')})` },
            [`.${e(`bg-gradient-l-${name}`)}`]: { backgroundImage: `linear-gradient(to left, ${colors.join(', ')})` }
          };
        }),
      ),
    },
